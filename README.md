...
Optional: provide a pom.xml as 2nd argument to classify updates by dependabots of 
dependencies with scope test into "Test dependencies" instead of "Runtime dependencies"

```bash
groovy release_notes.groovy commits.txt pom.xml > RELEASE_NOTES.md
```
---
